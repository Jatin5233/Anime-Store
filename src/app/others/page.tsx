...
export default function OthersPage() {
  ...
  const [filters, setFilters] = useState({
    anime: [] as string[],
    tags: [] as string[],
    category: ['charger', 'cover_and_cases'] as string[],
  ...
  const clearFilters = () => {
    setFilters({
      anime: [],
      tags: [],
      category: ['charger', 'cover_and_cases'],
    ...
    <div className="min-h-screen bg-gray-950 text-gray-100 z-10">
      ...
      <div className="mx-auto max-w-[1440px] px-4 md:px-6 lg:px-8 py-8">
        <CollectionHeader
          ...
          description="Explore our collection of chargers, covers, cases, and other anime-themed accessories."
          stats={{
